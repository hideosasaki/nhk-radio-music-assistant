...
echo "Installing SDK..."
docker_exec '/app/venv/bin/uv pip install --quiet --reinstall --no-deps "nhk-radio-python @ https://github.com/hideosasaki/nhk-radio-python/archive/refs/heads/main.tar.gz"'
